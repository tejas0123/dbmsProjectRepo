...
exports.saveproduct= (req,res,next)=>{
 const product = new Product(req.body.carname,req.body.carimageurl,req.body.price,req.body.Model,req.body.Brand,req.body.seats,req.body.colors,req.body.fuel,req.body.launch_year,req.body.category,req.body.Iimg1,req.body.Iimg2,req.body.Iimg3,req.body.Eimg1,req.body.Eimg2,req.body.Eimg3);
...
exports.addspecs=(req,res,next)=>{
    ...
    Product.addspecs(req.body.Scarname,req.body.Smodel,req.body.Scategory,req.body.tyresize,req.body.tankcapacity,req.body.suspension,req.body.groundclearance,req.body.Dimension,req.body.transmissiontype,req.body.emissionstd,req.body.maxtorque,req.body.maxpower,req.body.Engdisplacement,req.body.bluetoothaudio,req.body.kerbweight).then(result=>{
    res.render('admin-addproduct');
...
exports.savespecchanges=(req,res,next)=>{
  Product.savespecchanges(req.body.Scarname,req.body.Smodel,req.body.Scategory,req.body.tyresize,req.body.tankcapacity,req.body.suspension,req.body.groundclearance,req.body.Dimension,req.body.transmissiontype,req.body.emissionstd,req.body.maxtorque,req.body.maxpower,req.body.Engdisplacement,req.body.bluetoothaudio,req.body.kerbweight,req.body.id).then(result=>{
    res.redirect('/admin/delete-update');
  })
}
